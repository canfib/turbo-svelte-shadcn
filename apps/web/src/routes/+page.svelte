...
<main class="flex flex-col items-center justify-center gap-2 p-4" style="height: 100vh;">
  <div class="flex justify-center gap-6">
    ...
    <a
      ...
      aria-label="shadcn-svelte documentation"
    >
      <svg
  ...
  <h1
    class="lg:leading-[1.1 flex justify-center text-center text-3xl leading-tight font-bold tracking-tighter md:text-6xl"
  >
